...
import 'parte_model.dart';
export 'parte_model.dart';
...
class ParteWidget extends StatefulWidget {
  ...
  @override
  _ParteWidgetState createState() => _ParteWidgetState();
}

class _ParteWidgetState extends State<ParteWidget> {
  late ParteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ParteModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final parteCodigoResponse = snapshot.data!;
