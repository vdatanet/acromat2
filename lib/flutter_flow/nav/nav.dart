          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => SubmenuWidget(
                menu: params.getParam('menu', ParamType.String),
                idMenu: params.getParam('idMenu', ParamType.String),
                destino: params.getParam('destino', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'Fpcs',
              path: 'fpcs',
              builder: (context, params) => FpcsWidget(),
            ),
            FFRoute(
              name: 'Facs',
              path: 'facs',
              builder: (context, params) => FacsWidget(),
            ),
            FFRoute(
              name: 'Fpts',
              path: 'fpts',
              builder: (context, params) => FptsWidget(),
            ),
            FFRoute(
              name: 'Fmateriales',
              path: 'fmateriales',
              builder: (context, params) => FmaterialesWidget(),
            ),
            FFRoute(
              name: 'Ftrabajos',
              path: 'ftrabajos',
              builder: (context, params) => FtrabajosWidget(),
            ),
            FFRoute(
              name: 'Fcalendario',
              path: 'fcalendario',
              builder: (context, params) => FcalendarioWidget(),
            ),
            FFRoute(
              name: 'Fapts',
              path: 'fapts',
              builder: (context, params) => FaptsWidget(),
            ),
            FFRoute(
              name: 'Partes',
              path: 'partes',
            ...
            FFRoute(
              name: 'Parte',
              path: 'parte',
              builder: (context, params) => ParteWidget(
