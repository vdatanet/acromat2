                  ...
                  children: [
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          _model.apiResult589 = await RootGroup.loginCall.call(
                            username: _model.textController1.text,
                            password: _model.textController2.text,
                          );
                          if ((_model.apiResult589?.succeeded ?? true)) {
                            setState(() {
                              FFAppState().JWT = getJsonField(
                                (_model.apiResult589?.jsonBody ?? ''),
                                r'''$.token''',
                              ).toString();
                              FFAppState().Empleado = getJsonField(
                                (_model.apiResult589?.jsonBody ?? ''),
                                r'''$.idEmpleado''',
                              ).toString();
                              FFAppState().GrupoApp = getJsonField(
                                (_model.apiResult589?.jsonBody ?? ''),
                                r'''$.grupoApp''',
                              ).toString();
                            });
